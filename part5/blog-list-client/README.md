...
The application expects the back-end to be running on port 3003.

### Running

Clone the [top-level repo](https://github.com/dgrishajev/fso-submissions), go to this directory and run:
...
In case of an error try checking and killing processes on port 3000.
